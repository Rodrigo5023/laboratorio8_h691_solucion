    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        switch (action) {
            case "listar":
                ...
                request.setAttribute("generoSeleccionado", genero);
                streaming streaming = new streaming();
                streaming.setIdStreaming(0);
                request.setAttribute("streamingSeleccionado", streaming);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        switch (action) {
            ...
            case "filtrar":
                ...
                genero generoSeleccionado = listaGeneros.get(idGenero-1);
                request.setAttribute("generoSeleccionado", generoSeleccionado);
                streaming streamingSeleccionado = listaStreaming.get(idStreaming-1);
                request.setAttribute("streamingSeleccionado",streamingSeleccionado);
